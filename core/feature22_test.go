...
func Test01feature22(t *testing.T) {
	...
	expected := map[string]interface{}{"S": 15.7, "L": []interface{}{157, 187}, "Points": []interface{}{0, 2, 6, 8, 9, 9, 9, 9, 7, 2, 0}}
...
func Test02feature22(t *testing.T) {
	...
	expected := map[string]interface{}{"S": 251.3, "L": []interface{}{1257, 1297}, "Points": []interface{}{72, 85, 21, 26, 95, 72}}
	genericTester(t, feature22(arguments), expected, feature22Names, feature22Accuracies, feature22Types)
}
