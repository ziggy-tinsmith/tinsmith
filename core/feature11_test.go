...
func feature11Tester(t *testing.T, kk, gg, ll, ss, ee, tt, ett float64, krOK, grOK, kcOK, gcOK, okrOK, ogrOK, zmksOK, zmgsOK, wllOK, ddsOK []float64, aOK float64) {
	kr, gr, kc, gc, okr, ogr, zmks, zmgs, wll, dds, a := feature11(kk, gg, ll, ss, ee, tt, ett)
...
func Test01Feature11(t *testing.T) {
	feature11Tester(t, 200, 400, 100, 5, 10, 16, 20, []float64{141, 168, 194, 220, 247}, []float64{178, 204, 230, 257, 283}, []float64{39, 46, 54, 61, 68}, []float64{49, 56, 64, 71, 78}, []float64{141, 168, 194, 220, 247}, []float64{178, 204, 230, 257, 283}, []float64{31.4, 37.2, 43.0, 48.8, 54.7}, []float64{39.4, 45.2, 51.0, 56.9, 62.7}, []float64{36.3, 36.3, 36.3, 36.3, 36.3}, []float64{50.5, 54.8, 59.3, 64.0, 68.9}, 0.13)
}
