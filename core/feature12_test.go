...
var (
	feature12Names      = []string{"KR", "GR", "KC", "GC", "OKR", "OGR", "ZMKS", "ZMGS", "WLL", "D", "Area"}
	feature12Accuracies = []string{"%.0f", "%.0f", "%.0f", "%.0f", "%.0f", "%.0f", "%.1f", "%.1f", "%.1f", "%.1f", "%.2f"}
	feature12Types      = []bool{false, false, false, false, false, false, false, false, false, false, true}
)
...
func Test01Feature12(t *testing.T) {
	...
	genericTester(t, feature12(arguments), expected, feature12Names, feature12Accuracies, feature12Types)
}
